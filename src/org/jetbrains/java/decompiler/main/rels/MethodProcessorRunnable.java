...
public class MethodProcessorRunnable implements Runnable {
  ...
  public static RootStatement codeToJava(StructClass cl, StructMethod mt, MethodDescriptor md, VarProcessor varProc) throws IOException {
    ...
    if (DecompilerContext.getOption(Option.ENSURE_SYNCHRONIZED_MONITOR)) {
    ...
    if (DecompilerContext.getOption(Option.NO_EXCEPTIONS_RETURN)) {
    ...
    if (DecompilerContext.getOption(Option.TERNARY_CONDITIONS)) {
    ...
    while (true) {
      ...
      if (DecompilerContext.getOption(Option.IDEA_NOT_NULL_ANNOTATION)) {
      ...
      if (DecompilerContext.getOption(Option.PATTERN_MATCHING)) {
